...
public class FragmentAddItem extends Fragment
{
 ...
 public void uploadData()
 {
  ...
  if(imageUri != null)
  {
   ...
   StorageReference imgPath = storageRef.child("itemImage").child(Timestamp.now().toString() + ".jpeg");
   ...
   }).addOnCompleteListener(new OnCompleteListener<Uri>()
   {
    ...
    public void onComplete(@NonNull Task<Uri> task)
    {
     ...
     if(task.isSuccessful())
     {
      ...
      firebaseFireStore.collection("items").document().set(userItems).addOnCompleteListener(new OnCompleteListener<Void>()
      {
       @Override
