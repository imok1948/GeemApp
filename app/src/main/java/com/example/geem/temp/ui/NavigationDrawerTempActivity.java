package com.example.geem.temp.ui;
...
public class NavigationDrawerTempActivity extends AppCompatActivity
{
 ...
 protected void onCreate(Bundle savedInstanceState)
 {
  ...
  setContentView(R.layout.activity_navigation_drawer_temp);
